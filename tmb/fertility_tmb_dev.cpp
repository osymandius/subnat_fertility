  ...
  
{
  ...
  // Type rho_age(2*exp(lag_logit_rho_age)/(1+exp(lag_logit_rho_age))-1);
  // nll -= dnorm(lag_logit_rho_age, Type(0), Type(0.15));

  // Type rho_period(2*exp(lag_logit_rho_period)/(1+exp(lag_logit_rho_period))-1);
  // nll -= dnorm(rho_period, Type(0), Type(0.15));
