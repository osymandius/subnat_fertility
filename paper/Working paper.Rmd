...
The random effects over age, time, district, and country and TIPS have variances parameters which are estimated from the data -  $\alpha{_a} \sim RW1(\sigma_\alpha^{2})$; $\gamma{_t} \sim RW2(\sigma_\gamma^{2})$; and $\omega_{DHS-TIPS}, \omega_{MICS-TIPS} \sim RW1(\sigma^2_\omega)$. Gamma priors are specified on all precisions: $\sigma_\alpha^{-2}, \sigma_\gamma^{-2}, \sigma_\omega^{-2}, \sigma_{\eta_{1:5}}^{-2} \sim \Gamma(1, 2E5)$
